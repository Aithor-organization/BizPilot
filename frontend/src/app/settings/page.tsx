...
export default function SettingsPage() {
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-surface-500">비즈니스 설정을 관리하세요.</p>

      <div className="mt-6 grid grid-cols-2 gap-4">
        {settingsItems.map((item) => (
          <Link key={item.href} href={item.href} className="group card-surface p-6 hover:border-brand-200 hover:shadow-sm transition-all">
